...
#define CNT_ShortPress 	(2)  	//短按40ms
#define CNT_ShortLong	(50)	//短长按1s
#define CNT_LongPress 	(150) 	//长按3s
#define CNT_LongLongPress 	(200) 	//长按4s
...
#define Func_Long_Long	(0x04)		//长长按
