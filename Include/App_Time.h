...
//倒计时参数
#define CountDown_5s	500		//g_5ms_Count=5s/10ms=500;（10ms时基）
#define CountDown_3s	150		//g_3ms_Count=3s/20ms=150;（20ms时基）
#define CountDown_15s	750		//g_15s_Count=15s/20ms=750	（20ms时基）	
...
extern uint16 g_15s_Count;
extern uint16 g_AutoTurnOff_Count;
extern uint8 g_PreserveSpecialMode;
